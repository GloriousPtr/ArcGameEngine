...
namespace ArcEngine
{
	...
	ImGuiConsole::Message::Color ImGuiConsole::Message::GetRenderColor(Level level)
	{
		switch (level)
		{
			...
			case ImGuiConsole::Message::Level::Info: return { 0.20f, 0.80f, 0.20f, 1.00f }; // Green
			case ImGuiConsole::Message::Level::Debug: return { 0.00f, 0.50f, 0.50f, 1.00f }; // Cyan
			case ImGuiConsole::Message::Level::Warn: return { 0.80f, 0.80f, 0.20f, 1.00f }; // Yellow
			case ImGuiConsole::Message::Level::Error: return { 0.80f, 0.20f, 0.20f, 1.00f }; // Red
